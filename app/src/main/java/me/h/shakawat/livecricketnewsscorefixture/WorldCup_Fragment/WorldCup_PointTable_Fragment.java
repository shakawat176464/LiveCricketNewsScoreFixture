 ...
 */
public class WorldCup_PointTable_Fragment extends Fragment {
    ...
    public WorldCup_PointTable_Fragment() {
        // Required empty public constructor
        database = FirebaseDatabase.getInstance();
        news_reference = database.getReference("WorldCupPointTable");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_world_cup__point_table_, container, false);

        recyclerView = view.findViewById(R.id.worldCupPointTableRecyclerViewId);
