 ...
 */
public class WBBL_PoinTable_Fragment extends Fragment {
    ...
    public WBBL_PoinTable_Fragment() {
        // Required empty public constructor
        database = FirebaseDatabase.getInstance();
        news_reference = database.getReference("WBBLPointTable");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_wbbl__poin_table_, container, false);

        recyclerView = view.findViewById(R.id.wbblPointTableRecyclerViewId);
