 ...
 */
public class T10_PointTable_Fragment extends Fragment {
    ...
    public T10_PointTable_Fragment() {
        // Required empty public constructor
        database = FirebaseDatabase.getInstance();
        news_reference = database.getReference("T10PointTable");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_t10__point_table_, container, false);

        recyclerView = view.findViewById(R.id.t10PointTableRecyclerViewId);
