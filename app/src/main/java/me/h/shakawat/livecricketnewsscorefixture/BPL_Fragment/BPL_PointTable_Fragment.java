...
public class BPL_PointTable_Fragment extends Fragment {
    ...
    public BPL_PointTable_Fragment() {
        // Required empty public constructor
        database = FirebaseDatabase.getInstance();
        news_reference = database.getReference("BPLPointTable");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_bpl__point_table_, container, false);

        recyclerView = view.findViewById(R.id.bplPointTableRecyclerViewId);
