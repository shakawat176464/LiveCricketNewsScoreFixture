...
public class RecentViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
    ...
    public TextView txtTeamName,txtMatchFormat,txtDateTime,txtMatchStatus,txtMatchResult,txtStadiumName;
    ...
    public RecentViewHolder(@NonNull View itemView) {
        ...
        txtMatchStatus = itemView.findViewById(R.id.matchStatusTxt_Id);
        txtMatchResult = itemView.findViewById(R.id.matchResultTxt_Id);
