 ...
 */
public class WBBL_News_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_wbbl__news_, container, false);

        recyclerView = view.findViewById(R.id.wbblNewsRecyclerViewId);
