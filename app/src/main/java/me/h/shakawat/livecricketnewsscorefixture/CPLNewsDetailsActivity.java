...
public class CPLNewsDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cplnews_details);
        ...
        newses = database.getReference("CPLNews");
        ...
        if (getIntent()!=null)
            newsId=getIntent().getStringExtra("CPLNewsID");
        if (!newsId.isEmpty())
