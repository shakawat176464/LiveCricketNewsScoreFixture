...
public class IPLNewsDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_iplnews_details);
        ...
        newses = database.getReference("IPLNews");
        ...
        if (getIntent()!=null)
            bplNewsId=getIntent().getStringExtra("IPLNewsID");
