 ...
 */
public class WorldCup_News_Fragment extends Fragment {
    ...
    public WorldCup_News_Fragment() {
        // Required empty public constructor
        database = FirebaseDatabase.getInstance();
        news_reference = database.getReference("WorldCupNews");
            ...
            protected void onBindViewHolder(@NonNull WorldCupNewsViewHolder holder, int position, @NonNull WorldCupNews model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View v, int position, boolean isLongClick) {
                        ///for fixt crash
                        Intent newsDetails = new Intent(getContext(),WorldCupNewsDetailsActivity.class);
                        newsDetails.putExtra("WorldCupNewsId",adapter.getRef(position).getKey());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_world_cup__news_, container, false);

        recyclerView = view.findViewById(R.id.worldCupNewsRecyclerViewId);
