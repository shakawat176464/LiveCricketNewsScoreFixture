...
import me.h.shakawat.livecricketnewsscorefixture.IPLNewsDetailsActivity;
 ...
 */
public class IPL_News_Fragment extends Fragment {
    ...
    public IPL_News_Fragment() {
        // Required empty public constructor
        database = FirebaseDatabase.getInstance();
        news_reference = database.getReference("IPLNews");
            ...
            protected void onBindViewHolder(@NonNull BplNewsViewHolder holder, int position, @NonNull BplNews model) {
                ...
                holder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View v, int position, boolean isLongClick) {
                        ///code later
                        Intent newsDetails = new Intent(getContext(),IPLNewsDetailsActivity.class);
                        newsDetails.putExtra("IPLNewsID",adapter.getRef(position).getKey());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ipl__news_, container, false);

        recyclerView = view.findViewById(R.id.iplNewsRecyclerViewId);
