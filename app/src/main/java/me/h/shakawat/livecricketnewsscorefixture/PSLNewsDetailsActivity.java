...
public class PSLNewsDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pslnews_details);
        ...
        newses = database.getReference("PSLNews");
        ...
        if (getIntent()!=null)
            bplNewsId=getIntent().getStringExtra("PSLNewsID");
