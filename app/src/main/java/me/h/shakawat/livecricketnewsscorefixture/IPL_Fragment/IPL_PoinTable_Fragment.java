 ...
 */
public class IPL_PoinTable_Fragment extends Fragment {
    ...
    public IPL_PoinTable_Fragment() {
        // Required empty public constructor
        database = FirebaseDatabase.getInstance();
        news_reference = database.getReference("IPLPointTable");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_ipl__poin_table_, container, false);

        recyclerView = view.findViewById(R.id.iplPointTableRecyclerViewId);
