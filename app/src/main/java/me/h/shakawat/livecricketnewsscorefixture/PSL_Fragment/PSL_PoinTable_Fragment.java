 ...
 */
public class PSL_PoinTable_Fragment extends Fragment {
    ...
    public PSL_PoinTable_Fragment() {
        // Required empty public constructor
        database = FirebaseDatabase.getInstance();
        news_reference = database.getReference("PSLPointTable");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_psl__poin_table_, container, false);

        recyclerView = view.findViewById(R.id.pslPointTableRecyclerViewId);
