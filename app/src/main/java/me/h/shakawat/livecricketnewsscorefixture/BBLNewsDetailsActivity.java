...
public class BBLNewsDetailsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bblnews_details);
        ...
        newses = database.getReference("BBLNews");
        ...
        if (getIntent()!=null)
            worldCupNewsId=getIntent().getStringExtra("BBLNewsID");
